...
#
#     PHX_SERVER=true bin/dynamic_envision start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :dynamic_envision, DynamicEnvisionWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :dynamic_envision, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :dynamic_envision, DynamicEnvision.Mailer,
  ...
  config :ueberauth, Ueberauth.Strategy.Google.OAuth,
    ...
    redirect_uri: System.get_env("GOOGLE_REDIRECT_URI") || "https://#{host}/auth/google/callback"
